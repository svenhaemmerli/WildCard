...
//        panelJokerCards.setLayout(gblJockerCards);
        ...
        // <------------------------------ Buttons f�r die Aktionen hinzuf�gen ------------------------------------------------------------>
        /**
    ...
    public void createButtons(SpieldatenResponse response)
    {
        ...
        /**
         * @params anzahlNormalCards, anzahlJokerCards zuerst z�hlen, wie viele Buttons
         *         jeweils erstellt werden m�ssen
         */
         ...
         *         wird, an die richtige stelle zu schreiben (falls der K�nig auf Stelle
         *         15 gefunden wird (i = 15) k�nnte der button sonst nicht zugewiesen
         *         werden
         */
        int countNormal = 0;
        int countJoker = 0;
